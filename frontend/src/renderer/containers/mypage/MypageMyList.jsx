              ...
              <div className="relative">
                  <div className="relative">
                      <a
                          ...
                          title="이것이코딩테스트다with파이썬"
                          href="/product/183383935"
                      >
                          <div className="relative w-full rounded-md overflow-hidden dim pt-[100%] mb-3 md:mb-3.5">
                              <img
                                  alt="이것이코딩테스트다with파이썬"
                                  referrerPolicy="no-referrer"
                                  src="https://img2.joongna.com/media/original/2024/09/02/17252875407490Lg_WCL2Y.jpg?impolicy=thumb&size=150"
                                  decoding="async"
                                  data-nimg="fill"
                          ...
                          <div className="w-full overflow-hidden p-0 md:p-0 lg:p-0 xl:p-0 2xl:p-0">
                              ...
                              <div className="my-1">
                                  <span className="text-sm text-gray-400">안양1동</span>
                                  <span className="text-sm text-gray-400 mx-1">|</span>
                                  <span className="text-sm text-gray-400">40초 전</span>
                              </div>
