                      ...
                      <div className="my-item-con relative" key={index}>
                          <div className="my-content-con relative">
                              ...
                              >
                                  <div
                                      ...
                                      {item.AUCTION_ITEM_STATUS == 1 ? (
                                          <div className="z-10 pending item-status">대기</div>
                                      ): (
                                          <div className="z-10 ongoing item-status">진행</div>
                                      )}
                                      {/*<div className="z-10 pending item-status">대기</div>*/}
                                      {/*<div className="z-10 ongoing item-status">진행</div>*/}
                              ...
                              <div className="w-full overflow-hidden p-2 md:px-2.5 xl:px-4">
                                  <h2 className="line-clamp-2 min-h-[2lh] text-sm md:text-base">{item.AUCTION_ITEM_NAME}</h2>
                                  <div className="mt-2">
                                      <span className="font-bold">{item.AUCTION_ITEM_HIGHEST_PRICE}</span>
                                      <span className="ml-2 text-s text-gray-500 line-through">{item.AUCTION_ITEM_START_PRICE}</span>
                                  </div>
                                  {/*<div className="font-semibold space-s-2 mt-0.5 text-heading lg:text-lg lg:mt-1.5">*/}
                                  {/*    {price}원*/}
                                  {/*</div>*/}
