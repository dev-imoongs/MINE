...
const TradeListFilterContainer = () => {
  ...
  return (
    <div className="relative">
      ...
      <h2 className="text-[28px] font-normal mb-[10px]">
              ...
              <td className="!py-2">
                <ul className="grid grid-cols-6 text-sm">
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=101&amp;page=1">여성신발</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=102&amp;page=1">남성신발</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=103&amp;page=1">가방/핸드백</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=104&amp;page=1">지갑/벨트</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=105&amp;page=1">여성의류</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=106&amp;page=1">남성의류</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=107&amp;page=1">패션잡화</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=108&amp;page=1">시계/쥬얼리</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=109&amp;page=1">유아동</a>
                  </li>
                  <li className="flex justify-start items-center !mt-0 p-2 pl-0 w">
                    <a href="/search?category=110&amp;page=1">기타 수입명품</a>
                  </li>
                </ul>
              </td>
            </tr>
