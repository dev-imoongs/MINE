...
const TradeListFilterContainer = ({ itemsCount, filters, setFilters, categoryList, destinationType }) => {
    // 검색해서 경매 들어왔는지 여부
        ...
        <div className="relative">
            <div className="flex flex-col lg:flex-row lg:items-center gap-[6px] items-start mb-[10px]">
                <h2 className="text-2xl lg:text-[28px] font-normal w-[calc(100%-30px)] lg:w-auto text-jnBlack">
                    {isSearch && <strong className="font-semibold">{filters.searchKeyword} </strong>}
                    검색 결과
                </h2>
