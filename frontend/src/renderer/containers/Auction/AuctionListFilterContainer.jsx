...
const AuctionListFilterContainer = ({
  ...
  const categories = [
    ...
    { id: 103, name: "도서" },
    { id: 104, name: "뷰티/미용" },
    { id: 105, name: "취미/게임/음반" },
    { id: 106, name: "생활 가전" },
    { id: 107, name: "생활주방" },
    { id: 108, name: "의류" },
    { id: 109, name: "스포츠/레저" },
    { id: 110, name: "상품권/모바일티켓" },
    { id: 111, name: "식물" },
    { id: 112, name: "식품" },
  ];
                ...
                <ol className="flex flex-wrap items-center w-full mt-0 lg:mt-0">
                  {filters.category ? (
                    <li className="flex-shrink-0 px-0 mt-0 text-sm break-all transition duration-200 ease-in text-body first:ps-0 last:pe-0 hover:text-heading">
                      ...
                      >
                        {categories[filters.category - 101].name}
                      </Link>
                    </li>
                  ) : (
                    <li className="flex-shrink-0 px-0 mt-0 text-sm break-all transition duration-200 ease-in text-body first:ps-0 last:pe-0 hover:text-heading">
                  ...
                  {categories.map((categoryList) => {
                    return (
                      <li
                        ...
                        key={categoryList.id} // index를 key로 사용할 수 있지만, 고유한 id가 있으면 id 사용을 권장합니다.
                      >
                        <Link
                          to="#"
                          onClick={() => {
                            setCategory(categoryList.id);
                            toggleOpen();
                          }}
                        >
                          {categoryList.name}
                        ...
                        >
                          {filter.key === "category" ? (
                            <span className="truncate">
                              {categories[filter.value - 101].name}
                            </span>
                          ) : (
