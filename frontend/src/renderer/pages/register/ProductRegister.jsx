            ...
            <form>
                <div className={styles['form-group']}>
                    <div className={styles['image-container']}>
                        <div>
                            <input name="media" type="file" multiple="" accept="image/png, image/jpeg, image/jpg" className={styles['hidden']}/>
                            <button type="button" className={styles['image-button']}>
                                <div className={styles['flex']}>
                                    ...
                                    <p className={`${styles['mt-1']} ${styles['text-xs']} ${styles['text-jnGray-500']}`}>0/10</p>
                                </div>
                            </button>
                        </div>
                        <div className={styles['select-image-container']}>
                            <div className={styles['select-image']}>
                                ...
                                <button className={styles['absolute-top-right']}>
                ...
                <div className={styles['form-group']}>
                    ...
                    <div className={styles['price-group']}>
                        ...
                        <div className={styles['price-free']}>
                            <input type="checkbox" className={styles['hidden']} placeholder="판매가격 입력"/>
                            <div className={styles['svg-1']}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path className={styles['path1']} d="M23.5 12C23.5 18.3513 18.3513 23.5 12 23.5C5.64873 23.5 0.5 18.3513 0.5 12C0.5 5.64873 5.64873 0.5 12 0.5C18.3513 0.5 23.5 5.64873 23.5 12Z" stroke="#ddd" fill="#fff"></path>
                                    <path className={styles['path2']} d="M7 12.6667L10.3846 16L18 8.5" stroke="#ddd" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
                                </svg>
                            </div>
                            <span>무료나눔</span>
                        </div>
                ...
                <div className={styles['form-group']}>
                    <label>상품상태</label>
                    <button type='button' className={`${styles.btn} ${styles.old}`}>중고</button>
                    <button type='button' className={`${styles.btn} ${styles.new}`}>새상품</button>
                </div>

                <div className={styles['form-group']}>
                    <label>거래방법</label>
                    <div className={styles['trade-type-container']}>
                        <div className={styles['trade-type']}>
                            <input type="checkbox" className={styles['hidden']} id="direct" name="deal-method"/>
                            <div className={styles['svg-1']}>
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path className={styles['path1']} d="M23.5 12C23.5 18.3513 18.3513 23.5 12 23.5C5.64873 23.5 0.5 18.3513 0.5 12C0.5 5.64873 5.64873 0.5 12 0.5C18.3513 0.5 23.5 5.64873 23.5 12Z" stroke="#ddd" fill="#fff"></path>
                                    <path className={styles['path2']} d="M7 12.6667L10.3846 16L18 8.5" stroke="#ddd" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path>
