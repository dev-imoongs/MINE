...
const SellerInfo = React.memo(({ sellerInfo }) => {
    ...
    const { userEmail, userProfile, trustScore } = sellerInfo;
                    ...
                    <div>
                        <div className="flex">
                            <a className="flex items-center justify-between w-full pt-5 lg:pb-5" href="#">
                                <p className="text-[22px] font-semibold text-jnGray-900">{userEmail}</p>
                        ...
                        <div>
                            <div className="flex justify-between mt-2 text-[#0CB650]">
                                <p className="text-base font-medium">
                                    신뢰지수<span className="ml-1 text-lg font-semibold">{trustScore}</span>
                                </p>
